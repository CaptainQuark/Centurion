...
import centurion.model.model.HospitalMerchant;
import centurion.model.model.ItemMerchant;
...
public class GenericPlayground {
    ...
    private static void demoHospitalMerchant() {
        ...
        //centurion.model.dao.<Hero>getAllElements(FileNames.USER_HEROES.name()).forEach(System.out::println);
    }
